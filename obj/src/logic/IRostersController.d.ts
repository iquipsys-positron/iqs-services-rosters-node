...
export interface IRostersController {
    ...
    getRosterById(correlationId: string, roster_id: string, callback: (err: any, roster: RosterV1) => void): void;
    ...
    deleteRosterById(correlationId: string, roster_id: string, callback: (err: any, roster: RosterV1) => void): void;
}
